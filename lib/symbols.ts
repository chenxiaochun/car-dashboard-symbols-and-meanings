...
const rows: Array<[string, string, string, SymbolColor, string, string, string, string[]]> = [
  ...
  ["battery-warning-light", "Battery Warning Light", "Electrical", "red", "Charging system is not keeping the battery powered.", "Short distance only if necessary.", "Switch off nonessential electrics and get the alternator/battery checked.", ["charging light", "battery symbol", "plus minus", "red battery", "battery light on", "charging system warning", "alternator warning", "dashboard lights flicker", "lights on at startup"]],
  ...
  ["tire-pressure-warning", "Tire Pressure Warning", "Tires", "amber", "One or more tyres/tires may be underinflated.", "Usually yes, slowly.", "Check pressure and inflate to the placard value.", ["tyre pressure", "TPMS", "TPMS light", "horseshoe exclamation", "horseshoe dashboard light", "horseshoe symbol", "u shape exclamation", "flat tire symbol", "tire pressure light meaning", "TPMS flashing"]],
  ...
  ["traction-control-light", "Traction Control Light", "Stability", "amber", "Traction control is active or has a fault.", "Yes, with caution.", "If flashing, reduce throttle. If steady, inspect the system.", ["car with squiggly lines", "squiggly lines under car", "car with wavy lines symbol", "wavy lines under car", "traction control light", "traction control symbol", "TC light", "TCS light", "skid light", "slippery road", "stability control light", "ESC light", "ESP light", "VSC light", "Check VSC", "Service Traction Control", "DSC light"]],
