...
在 X 搜索栏粘贴（选 **Latest** 排序）：

```
"battery light" driving
"battery light" alternator
"traction control light"
"wavy lines" dashboard
"traction control" "check engine"
dashboard warning lights multiple
```

**回复原则：** 先写 2–3 句有用诊断，**最后一句**再给链接；别只丢 URL。
...
- ❌ 只留链接不写字
- ❌ 用 X **替代** BOG 论坛（SEO 价值不同）
- ❌ 堆 10 个 hashtag

---

*创建：2026-07-09 · 配合 `automotive-backlink-targets.md` + `paste-today.md`*
